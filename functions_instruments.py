...
def format_all_yaxis(fig, font_size, tick_font_size=11.5): 
    return fig.update_layout(font=dict(size=font_size), yaxis=dict(showticklabels=True, title_text='', tickangle=0, tickfont_size=tick_font_size, ticksuffix=' ', categoryorder='total ascending')) 
